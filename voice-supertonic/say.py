...
Сервер не нужен: модель грузится ~0.2с, каждый вызов самодостаточен.

Запуск:
    python say.py "Привет, как дела?"
    python say.py "Текст" --voice M1 --speed 1.2 --play
...
def main() -> None:
    ...
    ap.add_argument("--steps", type=int, default=8, help="шаги диффузии")
