...
def scan_row(img, y, x_end):
    ...
    probe-точки в порядке нахождения по ходу сканирования). Но в массиве
    (и в логе) точки стоят по своему МЕСТУ НА ЭКРАНЕ (geometric x), а не
    в конце — то есть probe №7 между точками 3 и 4 физически стоит между
    ними, но сохраняет присвоенный номер 7."""
