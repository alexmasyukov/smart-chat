...
# Короткие фонетически близкие хард-негативы для «эй кот».
HARD = ["эй", "кот", "эй код", "эй крот", "эй бот", "эй кит", "эй кто", "эй рот",
        "эй пот", "эй гот", "эй ты", "эй там", "эй кофе", "эй как дела", "окей",
        "привет кот", "серый кот", "мокрый кот", "кот спит", "котик", "котлета",
        "который час", "эй погоди", "эй стоп", "эй слушай", "эй привет", "хэй",
        "кода нет", "компот", "скотч", "крот роет", "эй, где ты", "нет", "да",
        "спасибо", "поехали", "дальше", "кот и пёс", "big cat", "hey cat"]
